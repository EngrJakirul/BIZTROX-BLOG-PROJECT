...
@section('body')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 align-self-center order-1 order-lg-2 mb-md-50">
                    <img class="img-fluid w-100" src="{{asset('/')}}front/assets/images/philosophy.jpg" alt="philosophy-image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <div class="row rounded bg-secondary">
                <!-- ceo image -->
                <div class="col-lg-5 rounded-left ceo-image" style="background-image: url({{asset('/')}}front/assets/images/ceo.jpg);"></div>
                <div class="col-lg-7">
                    <!-- ceo content -->
                    <div class="p-5">
    ...
    <section class="fun-facts overlay-dark section-sm" style="background-image: url({{asset('/')}}front/assets/images/cta.jpg);">
        <div class="container">
            <div class="row">
    ...
    <section class="bg-gray py-4">
        <div class="container">
            <div class="client-logo-slider align-self-center">
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-1.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-2.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-3.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-4.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-5.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-1.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-2.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-3.png" alt="client-logo"></a>
                <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}front/assets/images/client-logo-4.png" alt="client-logo"></a>
